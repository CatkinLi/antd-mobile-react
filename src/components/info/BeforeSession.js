    ...
    return(
      <div className={styles.before_body}>
        <div className={styles.before_content1}>
          <div className={`${styles.before_button} ${ selectTap ? styles.before_button_select : '' }`} onClick={() => this.selectTicket()}>
            索票
          </div>
          <div className={`${styles.before_button} ${ selectTap ? '' : styles.before_button_select }`} onClick={() => this.selectValid()}>
            有效
          </div>
          {
              ...
              <div style={{ height: 360, marginTop: 10 }}>
                <div className={styles.before_title}>
                  ...
                  <div style={{ marginLeft: 0, width: '40%', color: '#888888'}}>
                    <div className={ styles.before_circle }>
                      索票用户 ▾
                    </div>
                  </div>
                </div>
